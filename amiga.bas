...
SCREEN 2,640,480,2,4
WINDOW 2, "Battle Test", (0,0)-(615,415),32,2
' VARIABLES
Z=0
Y=1
A=Z
...
PRINT
INPUT "PRESS ANY KEY TO RETURN TO THE WORKBENCH."; A$
WINDOW CLOSE 2
SCREEN CLOSE 2
END
#data
