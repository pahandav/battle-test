...
860 PRINT "(Q) QUIT"
870 CALL KEY(0,C,AA)
871 IF AA=0 THEN 870
872 A$=CHR$(C)
880 IF A$="A" THEN 930
890 IF A$="M" THEN 990
900 IF A$="I" THEN 1100
910 IF A$="Q" THEN 2480
920 GOTO 780
...
1050 CALL KEY(0,C,AA)
1051 IF AA=0 THEN 1050
1052 A$=CHR$(C)
1053 C=VAL(A$)
...
1150 CALL KEY(0,C,AA)
1151 IF AA=0 THEN 1150
1152 A$=CHR$(C)
1153 C=VAL(A$)
...
2190 CALL KEY(0,C,AA)
2191 IF AA=0 THEN 2190
2192 A$=CHR$(C)
2193 C=VAL(A$)
