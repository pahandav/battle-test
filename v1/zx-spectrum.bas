...
360 PRINT
370 REM MAIN LOOP
380 IF A((V*A)+Y)=Z THEN GO TO 420
390 IF A=Z THEN GO TO 780
400 LET T=Z
410 GO TO 1190
420 REM ITERATE ATTACKER
430 IF A(Y)=Z THEN GO TO 2410
440 LET A=A+Y
...
860 PRINT "(Q) QUIT"
870 LET A$=INKEY$
871 IF A$="" THEN GO TO 870
880 IF A$="A" OR A$="a" THEN GO TO 930
890 IF A$="M" OR A$="m" THEN GO TO 990
900 IF A$="I" OR A$="i" THEN GO TO 1100
910 IF A$="Q" OR A$="q" THEN GO TO 2480
920 GO TO 780
930 REM ATTACK INPUT ROUTINE
940 GO SUB 2120
950 IF C=Z THEN GO TO 780
960 IF C>X THEN GO TO 930
970 IF C<Z THEN GO TO 930
980 GO TO 1190
...
1050 LET A$=INKEY$
1051 IF A$="" THEN GO TO 1050
1052 LET C=VAL A$
1060 IF C=Y THEN GO TO 1630
1070 IF C=X THEN GO TO 1850
1080 IF C=Z THEN GO TO 780
1090 GO TO 990
...
1150 LET A$=INKEY$
1151 IF A$="" THEN GO TO 1150
1152 LET C=VAL A$
1160 IF C=Y THEN GO TO 1980
1170 IF C=Z THEN GO TO 780
1180 GO TO 1100
...
1490 IF A<>Z THEN GO TO 1560
1500 PRINT "YOU HIT SOLDIER ";T;" FOR ";D;" HP."
1510 PRINT
1520 IF A((T*V)+Y)<>Z THEN GO TO 1550
1530 PRINT "YOU DEFEATED SOLDIER ";T
1540 PRINT
1550 GO TO 420
1560 IF D>Z THEN GO SUB 2330
1570 PRINT "SOLDIER ";A;" HIT YOU FOR ";D;" HP."
1580 PRINT
1590 IF A(Y)<>Z THEN GO TO 1620
1600 PRINT "YOU DIED."
1610 PRINT
1620 GO TO 420
...
1640 LET E=Z
1650 LET D=Z
1660 IF A(M+Y)>A(3) THEN GO TO 1810
1670 LET A(3)=A(3)-A(M+Y)
1680 GO SUB 2120
1690 IF C=Z THEN GO TO 990
1700 IF C>X THEN GO TO 1630
1710 IF C<Z THEN GO TO 1630
1720 LET C=A(M+3)+A((A*V+12)+Y)-((A((T*V+12)+Y))/X)-Y
1730 GO SUB 2090
1740 IF R<C THEN GO SUB 2380
1750 IF R>C THEN GO TO 1770
1760 LET D=(A(M+X)*(K-A((T*V+9)+Y))*C)/(U*K)
1770 IF D>Z THEN GO TO 1440
...
1860 LET E=3
1870 IF A(M+H)>A(3) THEN GO TO 1810
